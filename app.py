...
CERT_CHAR_WIDTH = 130 * mm      # Size (Width)
CERT_CHAR_HEIGHT = 130 * mm     # Size (Height)
CERT_CHAR_OPACITY = 0.35        # Opacity (0.35 is perfect as per your request)

# 👇👇👇 (અહીંથી પોઝિશન સેટ કરો) 👇👇👇
CERT_CHAR_MARGIN_RIGHT = 4 * mm   # જમણી બાજુથી કેટલું દૂર રાખવું? (Right Margin)
CERT_CHAR_MARGIN_TOP = 15 * mm    # ઉપરની બાજુથી કેટલું નીચે રાખવું? (Top Margin)
